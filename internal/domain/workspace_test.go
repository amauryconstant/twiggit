...
func (s *WorkspaceTestSuite) TestWorkspace_AddProject() {
	...
	s.Require().Error(err)
	s.Equal("workspace project already exists: project 'test-project' already exists in workspace", err.Error())
...
func (s *WorkspaceTestSuite) TestWorkspace_RemoveProject() {
	...
	s.Require().Error(err)
	s.Equal("workspace project not found: project 'nonexistent-project' not found in workspace", err.Error())
}
...
func (s *WorkspaceTestSuite) TestWorkspace_GetProject_Pure() {
	...
	s.Require().Error(err)
	s.Equal("workspace project not found: project 'nonexistent' not found in workspace", err.Error())
}
