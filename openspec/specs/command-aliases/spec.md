## Command-Aliases Spec

This specification defines Unix-style command aliases for frequently used twiggit commands, reducing typing friction and following common CLI conventions.
