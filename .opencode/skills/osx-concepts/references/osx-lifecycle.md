# osx Lifecycle Reference

Detailed guide to the osx workflow lifecycle, state transitions, and usage patterns.

---

## Overview

osx (OpenSpec Extended) is a **fluid, iterative workflow** for OpenSpec changes. Commands are actions you can take anytime—dependencies enable what's possible, they don't lock you into phases.
...
AI:  Ready when you are. Run /osx:new add-rate-limiting
```
...
**Example**:
```
You: /osx:new add-dark-mode
AI:  Created openspec/changes/add-dark-mode/
     Schema: spec-driven
     
     Ready to create: proposal
     Use /osx:continue or /osx:ff
```
...
Now available: tasks
Run /osx:continue to create the next artifact.
```
...
AI:  Fast-forwarding add-dark-mode...
     ...
     Ready for implementation. Run /osx:apply to begin.
```
