...
Structure and format for test compliance reports generated by osx-review-test-compliance.
...
```bash
# Custom output path
osx-review-test-compliance --report /path/to/report.md
```
...
osx-review-test-compliance --requirement "User Authentication"

# Exclude specific requirements
osx-review-test-compliance --exclude "Session Expiration"

# Filter by confidence
osx-review-test-compliance --min-confidence 70
```
...
osx-review-test-compliance --silent
```
...
osx-review-test-compliance --verbose
```
